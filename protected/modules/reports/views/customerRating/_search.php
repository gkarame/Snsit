...
<div class="row width274 ">
		<div class="selectBg_search">
			...
			<div class="select_container width165" >
				<?php echo $form->dropDownList($model, 'rate', array('1'=>'1','2'=>'2','3'=>'3'), array('prompt' => Yii::t('translations', 'Choose Rate'))); ?>
			</div>
		</div>
	</div>
	...
	<div class="row width274 margint10">
		<div class="selectBg_search">
			...
			<span class="spliter"></span>
			<div class="select_container width165" >
				<?php echo $form->dropDownList($model, 'year', Invoices::getYears(), array('prompt' => Yii::t('translations', 'Choose Year'))); ?>
			</div>
		</div>
	</div>
