...
foreach($timesheet as $key=>$expens){?>
	<div class="project_thead project" data-id="<?php echo $key;?>" style="border-bottom: 1px solid #BABABA;"> 
		...
		<div class="table_rep">
			<table class="first">
				<tr>
					<td class="h3" style="padding-top:20px;padding-left:20px;font-family:arial;border-top:1.5px solid #567885;"><b>Customer:</b> <?php echo Customers::getNameById($key);?></td>
					<td class="h3" style="padding-top:20px;font-family:arial;font-family:arial;border-top:1.5px solid #567885;"><b>From Date:</b> <?php echo date('d/m/Y',strtotime($start_date)); ?></td>
				</tr>
				<tr>
					...
					<td class="h3" style="padding-bottom:20px;font-family:arial;border-bottom:1.5px solid #567885;"><b>To Date:</b> <?php echo date('d/m/Y',strtotime($end_datee)); ?></td>
				</tr>
			</table>
			<table class="second">
				<tr>
					<th class="h2" style="text-align:left;font-family:arial;width:8%;border-top:1.5px solid #B20533;border-bottom:1.5px solid #B20533;border-right:1px solid #567885;padding-left:20px">Item</th>
					<th class="h2" style="text-align:left;font-family:arial;width:37%;border-top:1.5px solid #B20533;border-bottom:1.5px solid #B20533;border-right:1px solid #567885;padding-left:20px">Expense Type</th>
					<th class="h2" style="text-align:left;font-family:arial;width:25%;border-top:1.5px solid #B20533;border-bottom:1.5px solid #B20533;border-right:1px solid #567885;padding-left:20px">Amount USD (Billable)</th>
					<th class="h2" style="text-align:left;font-family:arial;width:30%;border-top:1.5px solid #B20533;border-bottom:1.5px solid #B20533;;padding-left:20px">Amount USD (Not Billable)</th>
				</tr>
				<?php 
					$index = 0;
					$total_bill = 0;
				...
				?>
					<tr>
						<td class="h3" style="text-align:left;font-family:arial;border-right:1px solid #567885;padding-left:20px"><?php echo ++$index;?></td>
						<td class="h3" style="text-align:left;font-family:arial;border-right:1px solid #567885;padding-left:20px"><?php echo Codelkups::getCodelkup($key_type);?></td>
						<td class="h3" style="text-align:left;font-family:arial;border-right:1px solid #567885;padding-left:20px"><?php echo Utils::formatNumber($bill);?></td>
						<td class="h3" style="text-align:left;font-family:arial;padding-left:20px"><?php echo Utils::formatNumber($not_bill);?></td>
					</tr>
					<?php 
						$total_bill += $bill;
