...
<table class="first">
	...
	<tr>
		...
		<td class="h3" style="padding-top:20px"><?php if($_POST['Requests']['user_id'] != null) echo $_POST['Requests']['user_id']; else echo "All"?></td>
	</tr>
	<tr>
		<td class="h3_bold">Type:</td>
		<td class="h3"><?php if($_POST['Requests']['type'] != null) echo $_POST['Requests']['type']; else echo "All"?></td>
	</tr>
	<tr>
		<td class="h3_bold">Start Date:</td>
		<td class="h3"><?php echo $_POST['Requests']['StartDate'];?></td>
	</tr>
	<tr>
		<td class="h3_bold" style="padding-bottom:20px;">End Date:</td>
		<td class="h3" style="padding-bottom:20px;"><?php echo$_POST['Requests']['EndDate']?></td>
	</tr>
</table>
