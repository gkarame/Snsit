...
class InternalController extends Controller{
    ...
    public function actionsendBiWeeklyUpdate(){$tasks = Yii::app()->db->createCommand("SELECT * FROM internal WHERE status= 0")->queryAll();        
        ...
        if ($notif != NULL && !empty($tasks)) {
            ...
            $message .= "<table  style='font-family:Calibri;border:1px solid #000000;font-size: 13 px;border-collapse:collapse;width: 100%' ><tr  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'><th  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;width: 130px;'>Project</th><th  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'>PM</th><th  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;width: 105px;'>BM</th><th  style='font-family:Calibri;border:1px solid #000000;font-size: 13 px;width:15%;'>Assigned Resources</th><th  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'>Completion Rate</th><th style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;width: 70px;'>Last 2 Weeks</th><th  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'>Actual MDs</th><th style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;width: 70px;'>Pending Tasks</th><th style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;width: 70px;'>Closed Tasks</th><th style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'>Last Update</th></tr>";
            foreach ($tasks as $select) {  
            	$rec='';              
                $resources= Internal::getAssignUsersPerProject($select['id']);
                if(!empty($resources))
				...
				$lastweekdone= InternalTasks::closedTaskslastTWOweekorAll($select['id']);
                if($closed>0){ $rate=$closed*100/$alltasks; }else{ $rate= 0; }
                $message .= "<tr  style='    border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'><td  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'><a href='".Yii::app()->createAbsoluteUrl('internal/view', array('id'=>$select['id']))."'>".$select['name']."</a></td><td  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'>".Users::getNameById($select['project_manager'])."</td><td  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'>".Users::getNameById($select['business_manager'])."</td><td  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;'>".$rec."</td><td  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;text-align:center;'>".Utils::formatNumber($rate,2)."%</td><td  style='font-family:Calibri;border:1px solid #000000;font-size: 13 px;text-align:center;border-collapse:collapse;'>".$lastweekdone."</td><td  style='font-family:Calibri;border:1px solid #000000;font-size: 13 px;text-align:center;border-collapse:collapse;'>".Utils::formatNumber((float)Internal::getTimeSpentPerProject($select['id']),2,'.',' ')."</td><td  style='border-collapse:collapse;font-family:Calibri;border:1px solid #000000;font-size: 13 px;text-align:center;'>".$pending."</td><td  style='font-family:Calibri;border:1px solid #000000;font-size: 13 px;text-align:center;border-collapse:collapse;'>".$closed."</td><td style='font-family:Calibri;border:1px solid #000000;font-size: 13 px;border-collapse:collapse;text-align: right'>".Internal::getlastupdate($select['id'])."</td></tr>";
			}
