...
if (class_exists('TCPDF', false)) {
	...
	require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'fpdi2tcpdf_bridge.php' );
}
//require_once('fpdf_tpl.php');
//require_once('fpdi_pdf_parser.php');

require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'fpdf_tpl.php');
require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'fpdi_pdf_parser.php');
