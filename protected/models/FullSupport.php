<?php
class FullSupport extends CActiveRecord{
	public $contact_name;
	...
	public function rules(){
		return array(
			array('from_date,primary_contact,secondary_contact', 'required'),
			array('primary_contact,secondary_contact,type', 'numerical', 'integerOnly'=>true),
			array('primary_contact,secondary_contact,type', 'safe', 'on'=>'search'),
		);
	}
