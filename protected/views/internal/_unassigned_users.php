<form id="unassigned-users-form" method="post"><div class="listofactions unassigned ">			
			...
			<ul class="act" style=" height:30px; padding-top:20px; width:251px;">	<li class="customBtn">
					...
					<a href="javascript:void(0);" class="customCancelBtn ua" onclick="$('#users-list').fadeOut(100);"><?php echo Yii::t('translation', 'Cancel');?></a>	</li></ul>	</div></form>