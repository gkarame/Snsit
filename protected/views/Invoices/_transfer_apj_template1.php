...
<table class="firstt">
    ...
    <tr>
        <td colspan="2"><img style="width:300px;margin-top:-10px" src="<?php echo Yii::app()->getBaseUrl().'/images/snsapj_logo.png';?>" /></td>
        <td></td>
    </tr>
    <tr>
        <td colspan="3"></td>
...
<table class="second">
    ...
    <tr>
     ...
     <tr>
        <td colspan="4" class="h3" style="padding:2px;padding-top:15px;font-size:16px;font-family:Calibri;" ><b>Messrs. Standard Chartered Bank (Singapore) Limited </b> </td>
    </tr>
     <tr>
        <td colspan="4" class="h3" style="padding:2px;font-size:16px;font-family:Calibri;" ><b><span style="text-decoration: underline;">Subject:</span> Transfer to BOB - SNS AUD Account - Transfer <?php echo $Transfernb;?></b> </td>
    </tr>
      <tr>
      ...
      <tr>
        <td colspan="4" class="h3" style="padding:2px;padding-top:15px;font-size:16px;font-family:Calibri">Kindly transfer from SNSAPJ AUD current account number 0104185864 the amount of <b> AUD <?php echo Utils::formatNumber($total,2);?> (<?php echo $word;?>)</b>  to the following Bank Account. Transfer to be conducted today: </td>
    </tr>
...
<table class="second" >
    <tr>
        ...
        <td colspan="2" class="h3" style="padding:2px;padding-top:15px;font-size:16px;font-family:Calibri;text-align:right !important;">Bank of Beirut<br />Bauchrieh Branch </td>
     ...
     <tr>
        ...
        <td colspan="2" class="h3" style="padding:2px;padding-top:8px;font-size:16px;font-family:Calibri;text-align:right !important;">SNS Supply Network Solutions SAL <br />(Offshore)</td>
     ...
     <tr>
        ...
        <td colspan="2" class="h3" style="padding:2px;padding-top:8px;font-size:16px;font-family:Calibri;text-align:right !important;">LB51 0075 0000 0002 7401 6490 5400</td>
      ...
      <tr>
        ...
        <td colspan="2" class="h3" style="padding:2px;padding-top:8px;font-size:16px;font-family:Calibri;text-align:right !important;">BABELBBE </td>
