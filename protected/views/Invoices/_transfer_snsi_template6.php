...
<table class="second">
    ...
    <tr>
     ...
     <tr>
        <td colspan="4" class="h3" style="padding:2px;font-size:16px;font-family:Calibri;" ><b><span style="text-decoration: underline;">Subject:</span> Transfer to NECB SNSAPJ - Transfer <?php echo $Transfernb;?></b> </td>
    </tr>
      <tr>
      ...
      <tr>
        <td colspan="4" class="h3" style="padding:2px;padding-top:15px;font-size:16px;font-family:Calibri">Kindly transfer from SNSI Euro current account number 901966/461/03 the amount of <b> Euros <?php echo Utils::formatNumber($total,2);?> (<?php echo $word;?>)</b>  to the following Bank Account. Transfer to be conducted today: </td>
    </tr>
...
<table class="second" >
    <tr>
     ...
     <tr>
        ...
        <td colspan="2" class="h3" style="padding:2px;padding-top:8px;font-size:16px;font-family:Calibri;text-align:right !important;">LB70004820500265210694602000</td>
