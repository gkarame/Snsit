...
<table class="first">
	...
	<tr>
	<!--<td class="h3" style="padding:5px;">Bank Name: Standard Chartered Bank (Singapore) Limited</td>-->
	<td class="h3" style="padding:5px;">16Raffles Quay,#33-03 Hong Leong</td>
		<td style="padding:5px;border-bottom:1.5px solid #fff;width:29%"></td>
	...
	<tr>
	    ...
	    <td class="h3" style="padding:5px;">	Build, Singapore048581</td>
		<td style="padding:5px;border-bottom:1.5px solid #fff;width:29%"></td>
	...
	<!--	<td class="h3" style="padding:5px;">Swift: SCBLSG22</td>-->
...
<table class="second">
	...
	<?php foreach ($models as $rez){?>
		...
		{?>
			<tr>
				...
				<td style="border-right:1px solid #476976"><h3 style="font:15px Calibri;"><?php echo $rez->invoice_title; ?> <?php echo (isset($rez->id_ea))? "EA#".$rez->id_ea:""?><?php echo($model->type=='T&M')?   " - Billable Hours: ".TandM::gethoursbillablepereaNoAust($model->id_ea, $model->invoice_date_month, $model->invoice_date_year):"";?></h3></td>
	...
	<tr>
		<td colspan="4" class="h3" style="padding:2px;font-size:15px;;font-family:Calibri">As per invoice SNS APJ# <a href=<?php echo Yii::app()->createAbsoluteUrl('invoices/view',array('id'=>$model->id));?>><?php echo $model->snsapj_partner_inv; ?> </a>, this invoice represent <?php echo $model->sns_share ?> % of the total SNS APJ Invoice.</td>
	</tr>
	<tr>
