...
<table class="first">
	...
	<tr>
		...
		<td style="padding:5px;border-bottom:1.5px solid #fff;width:29%"></td>
		<td class="h3" style="padding:5px;"><?php if ($model->currency == 9){echo 'Account# :009019660002 <br/> IBAN#: LB93 0056 0000 0000 0090 1966 0002'; }else if ($model->currency == 8){echo 'Account# :009019660003 <br/> IBAN#: LB66 0056 0000 0000 0090 1966 0003'; }else if ($model->currency == 174){echo 'Account#: 009019660007 <br/> IBAN#: LB55 0056 0000 0000 0090 1966 0007'; }else{ echo 'Account# :009019660002 <br/> IBAN#: LB93 0056 0000 0000 0090 1966 0002'; } ?> </td>
	</tr>
	<tr>
	...
	<?php foreach ($models as $rez){ ?>
		...
		{?>
			<tr>
				...
				<td style="border-right:1px solid #476976"><h3 style="font:15px Calibri;"><?php echo $rez->invoice_title; ?> <?php echo (isset($rez->id_ea))? "EA#".$rez->id_ea:""?></h3><?php echo($model->type=='T&M')?   " - Billable Hours: ".TandM::gethoursbillableperea($model->id_ea, $model->invoice_date_month, $model->invoice_date_year):"";?></td>
