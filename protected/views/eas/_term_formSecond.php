<div class="tache new term">	
	<fieldset class="terms_fieldset">
			...
			<div class="input_text">
				<div class="hdselect" >
					<?php $this->widget('zii.widgets.jui.CJuiAutoComplete',array(
							'model' => $model, 'attribute' => "[$id]milestone",	'source'=>EaPaymentTerms::getAllAutocomplete(),	'id'=>'nsec',
							'options'=>array(
		...
		<?php } ?>
		<div style="right:115px;" class="save" onclick="updateTerm(this, '<?php echo $id;?>');showItemFormNew(true);return false;"><u><b>NEW</b></u></div>		
		<div style="right:75px;" class="save" onclick="updateTerm(this, '<?php echo $id;?>');return false;"><u><b>SAVE</b></u></div>
		<div style="color:#333;" class="save" onclick="$(this).parents('.tache.new').siblings('.tache').show();$(this).parents('.tache.new').remove();<?php if (!$model->isNewRecord) {?>$.fn.yiiGridView.update('terms-grid');panelClip('.term_clip');
