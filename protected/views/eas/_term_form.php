<div class="tache new term">	
	<fieldset class="terms_fieldset">
			...
			<div class="input_text">
				<div class="hdselect">
					<?php $this->widget('zii.widgets.jui.CJuiAutoComplete',array(
							'model' => $model,'attribute' => "[$id]milestone",'source'=>EaPaymentTerms::getAllAutocomplete(),
							'options'=>array(
		...
		<?php } ?>
		<div style="right:115px;" class="save" onclick="updateTerm(this, '<?php echo $id;?>');showItemFormNew(this, true);return false;"><u><b>NEW</b></u></div>		
