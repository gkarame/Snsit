...
<div class="tm_approval grid ">
	<div class="thead"> 
		...
		<div class="column375 item side-borders bold">Comment</div>
					...
					data-id-user="<?php echo $key_user;?>">
						...
						<div class="thead task_thead"  id="taskheader" data-id="<?php echo $time['id'];?>"  data-id="<?php echo $time['id'];?>" data-id_timesheet="<?php echo $key_time;?>"
						 data-id_prj="<?php echo $key;?>" data-id-user="<?php echo $key_user;?>">
							...
							<div class="column375 item side-borders no-border margint5 paddingl5" style="text-align: left;">
					...
					data-id-user="<?php echo $key_user;?>">
						...
						<div class="thead task_thead"  id="taskheader" data-id="<?php echo $time['id'];?>"  data-id="<?php echo $time['id'];?>" data-id_timesheet="<?php echo $key_time;?>"
						 data-id_prj="<?php echo $key;?>" data-id-user="<?php echo $key_user;?>">
							...
							?>
							<div class="column375 item side-borders no-border margint5 " style="text-align: left;">
							
							<textarea  spellcheck="false" class="column375 item  no-border" style=" resize:none ; overflow:auto; background-color:white;  " rows="1" cols="50"><?php echo $time['comment'];?></textarea>
