<div class="settings-view mytabs hidden"><?php $tabs = array();
	...
	if (GroupPermissions::checkPermissions('settings-codelists')){	$tabs[Yii::t('translations', 'Code Lists')] =  $this->renderPartial('_codeLists', array('codelists_categories'=>$codelists_categories), true);	}
