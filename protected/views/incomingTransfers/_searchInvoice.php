<div class="wide search" id="search-checklists"><?php $form=$this->beginWidget('CActiveForm', array('action'=>Yii::app()->createUrl($this->route),'method'=>'get',)); ?>
		...
		<div class="row width_common"><div class="selectBg_search">	<?php echo $form->label($model,'it_no'); ?>
				<span class="spliter"></span><div class="select_container ">	<?php echo $form->textField($model,'it_no',array('class'=>'width141')); ?>		</div>	</div></div>
