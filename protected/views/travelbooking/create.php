...
<fieldset id="travel_fields" class="create"> 
	<div class="formColumn">
		...
		<div class="row">
			...
			<?php echo CCustomHtml::error($model, 'id_user', array('id'=>"TravelBooking_id_user_em_")); ?>
		...
		<div class="row">
			<?php echo CHtml::activeLabelEx($model, 'origin_country'); ?>
			
			<div class="selectBg_create">
				<?php echo CHtml::activeDropDownList($model, 'origin_country', TravelBooking::getAllCountriesSelect(), array('prompt'=>Yii::t('translations', 'Select Country'))); ?>
			</div>
			
			<?php echo CCustomHtml::error($model,'origin_country', array('id'=>"Travel_origin_country_em_")); ?>
		</div>
