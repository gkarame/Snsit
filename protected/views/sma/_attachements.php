...
$(document).ready(function() {
	$("button.delete").click(function(){
	    $.ajax({
	 		type: "GET",
	 		data: {'customer':$(this).attr('data-customer'),'filename':$(this).attr('data-filename'),'id':$(this).attr('data-id')},				
		  	url: "<?php echo Yii::app()->createAbsoluteUrl('supportDesk/deleteUpload');?>", 
		  	dataType: "json",
		  	success: function(data) {
			  	if (data) {
				  		if (data.status == 'success' && data.html) {
				  			$('#attachament-change').html(data.html);
				  		}
