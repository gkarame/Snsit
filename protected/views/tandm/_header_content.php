<div class="view_row"><div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('invoice_number')); ?></div>
...
</div><div class="view_row"><div class="general_col1 "><?php echo CHtml::encode($model->getAttributeLabel('customer')); ?></div>
...
</div><div class="view_row"><div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('invoice_title')); ?></div>
...
</div><div class="view_row"><div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('payment #')); ?></div>
...
</div><div class="view_row"><div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('currency')); ?></div>
	...
	<div class="general_col4 status_invoice "><?php echo CHtml::encode($model->status); ?></div></div>
<div class="view_row"><div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('partner')); ?></div>
	...
	<?php }else{ ?>	<div class="general_col2 "></div>	<?php }?>	<div class="general_col3 "><?php echo CHtml::encode($model->getAttributeLabel('partner_inv')); ?></div>
	<div class="general_col4 "><?php echo CHtml::encode($model->partner_inv); ?></div></div><div class="view_row">
...
</div><div class="view_row"><div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('gross_amount')); ?></div>
	...
	<div class="general_col4 "><?php echo CHtml::encode(Utils::formatNumber($model->partner_amount)); ?></div></div>
<div class="view_row">	<?php $j = ($model->invoice_date_month)?(date("F", mktime(0, 0, 0,$model->invoice_date_month))." "):" ";
		  $j.= ($model->invoice_date_year)?$model->invoice_date_year:"";	?>	<div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('invoice_date_month')); ?></div>
	<div class="general_col2 "><?php echo CHtml::encode($j); ?></div>	<div class="general_col3 "><?php echo CHtml::encode($model->getAttributeLabel('sold_by')); ?></div>
	<div class="general_col4 "><?php echo CHtml::encode(( $model->sold_by != 0)?$model->iUnit->codelkup:""); ?></div></div>
<div class="view_row">	<div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('old')); ?></div>
...
</div><div class="view_row"><div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('Pay before date')); ?></div>
	...
	<div class="general_col4 "><?php echo CHtml::encode($model->partner_status); ?></div></div><div class="view_row"><div class="general_col1"><?php echo CHtml::encode($model->getAttributeLabel('type')); ?></div>
	<div class="general_col2 "><?php echo CHtml::encode($model->type); ?></div></div><div class="horizontalLine smaller_margin"></div>
