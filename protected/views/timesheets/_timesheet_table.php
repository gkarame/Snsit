...
<?php if(strtotime($model->week_start)< strtotime('2015-08-23')) {?>
 ...
 <?php } else {?>
	...
	<?php $showPrj = 0; $prjArr = array(); $taskArr = array();  $prj = 0; $mshowPrj = 0;   $mprjArr = array(); $mtaskArr = array();  $mprj = 0;?>
	...
	<?php foreach($data as $task) { 
	 ...
	 ?>
			<div class="thead project_thead"> 
				...
				<?php $taskCertainDate = $model->week_start; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'0'); ?>
				...
				<?php $taskCertainDate = $model->week_start . ' + 1 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'0'); ?>
				...
				<?php $taskCertainDate = $model->week_start . ' + 2 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'0'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 3 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'0'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 4 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'0'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 5 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'0'); ?>
				<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?> weekend <?php } ?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 6 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'0'); ?>
				...
				<div class="column80 item side-borders side-borders-last"><?php $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'],'','0'); ?><?php echo $resources; ?></div>
			</div>
		<?php }   ?>
			...
			<div class="thead task_thead" data-id="<?php echo $task['id_task'];?>" data-default="0" data-billable="<?php echo $task['task_billabillity'];?>">
				<div class="column250 item side-borders side-borders-first"><span class="deleteFromTimesheet" data-id="<?php echo $task['id_task']; ?>"></span>&nbsp;&nbsp;&nbsp;<?php echo $task['task_description']?></div>
					<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?> weekendtask <?php } ?>">
						<?php $taskCertainDate = $model->week_start; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'0'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="<?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?>weekendtask<?php } else { } ?>" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start . ' + 1 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'0'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start  . ' + 2 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'0'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start  . ' + 3 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'0'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start  . ' + 4 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'0'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?> weekendtask <?php } ?>">
						<?php $taskCertainDate = $model->week_start  . ' + 5 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'0'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="<?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?>weekendtask<?php } else { } ?>" />
					</div>
					<div class="column80 item side-borders weekendtask">
						<?php $taskCertainDate = $model->week_start  . ' + 6 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'0'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"   data-weekend="weekendtask" />
					</div>	
				<div class="column80 item side-borders side-borders-last"><span><?php echo Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'],'','0'); ?></span></div>
			</div>
		<?php } ?>
	<?php } ?>	

	<?php $showPrj = 0; $prjArr = array(); $taskArr = array();  $prj = 0; $mshowPrj = 0;   $mprjArr = array(); $mtaskArr = array();  $mprj = 0;?>
	<?php foreach($internal_projects as $task) { 
		if ($task['id_project'] != $prj && !in_array($task['id_project'], $prjArr)) { 		
		$prj = $task['id_project']; array_push($prjArr, $task['id_project']);
	 ?>
			<div class="thead project_thead"> 
				...
				<?php $taskCertainDate = $model->week_start; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'3'); ?>
				<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?> weekend <?php } ?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources;  ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 1 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'3'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 2 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'3'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 3 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'3'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 4 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'3'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 5 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'3'); ?>
				<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?> weekend <?php } ?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 6 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'], $taskCertainDate,'3'); ?>
				<div class="column80 item side-borders weekend" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<div class="column80 item side-borders side-borders-last"><?php $resources = Timesheets::getCurrentProjectTotalTime($model->id, $task['id_project'],'','3'); ?><?php echo $resources; ?></div>
			</div>
		<?php }   ?>
		
		<?php if (!in_array($task['id_task'], $taskArr)) { array_push($taskArr, $task['id_task']); ?>
			<div class="thead task_thead" data-id="<?php echo $task['id_task'];?>" data-default="3" data-billable="<?php echo $task['task_billabillity'];?>">
				<div class="column250 item side-borders side-borders-first"><span class="deleteFromTimesheet" data-id="<?php echo $task['id_task']; ?>"></span>&nbsp;&nbsp;&nbsp;<?php echo $task['task_description']?></div>
					<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?> weekendtask <?php } ?>">
						<?php $taskCertainDate = $model->week_start; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'3'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="<?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?>weekendtask<?php } else { } ?>" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start . ' + 1 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'3'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start  . ' + 2 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'3'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start  . ' + 3 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'3'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start  . ' + 4 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'3'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?> weekendtask <?php } ?>">
						<?php $taskCertainDate = $model->week_start  . ' + 5 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'3'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="<?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?>weekendtask<?php } else { } ?>" />
					</div>
					<div class="column80 item side-borders weekendtask">
						<?php $taskCertainDate = $model->week_start  . ' + 6 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'], $taskCertainDate,'3'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($task['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"   data-weekend="weekendtask" />
					</div>	
				<div class="column80 item side-borders side-borders-last"><span><?php echo Timesheets::getUserTimeOnTaskByDay($model->id, $task['id_task'],'','3'); ?></span></div>
			</div>
		<?php } ?>
	<?php } ?>	


	<?php foreach($maintenance_tasks as $mtask) { 
		
	
		if ($mtask['id_project'] != $mprj && !in_array($mtask['id_project'], $mprjArr)) { 
		
		$mprj = $mtask['id_project']; array_push($mprjArr, $mtask['id_project']);
	 ?>
			<div class="thead project_thead"> 
				<div class="column250 item side-borders side-borders-first projectName">
					<span class="deleteFromTimesheet" data-id="<?php echo $mtask['id_project']; ?>"></span>&nbsp;&nbsp;&nbsp;
					<span class="plus-minus" data-collapsed="1" href="javascript:void(0)"></span>&nbsp;&nbsp;&nbsp;
					<?php echo $mtask['project_name']; ?>
				</div>
				<?php $taskCertainDate = $model->week_start; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $mtask['id_project'], $taskCertainDate,'2'); ?>
				<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?> weekend <?php } ?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 1 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $mtask['id_project'], $taskCertainDate,'2'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 2 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $mtask['id_project'], $taskCertainDate,'2'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 3 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $mtask['id_project'], $taskCertainDate,'2'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 4 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $mtask['id_project'], $taskCertainDate,'2'); ?>
				<div class="column80 item side-borders" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 5 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $mtask['id_project'], $taskCertainDate,'2'); ?>
				<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?> weekend <?php } ?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<?php $taskCertainDate = $model->week_start . ' + 6 day'; $resources = Timesheets::getCurrentProjectTotalTime($model->id, $mtask['id_project'], $taskCertainDate,'2'); ?>
				<div class="column80 item side-borders weekend" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>"><?php echo $resources; ?></div>
				<div class="column80 item side-borders side-borders-last"><?php $resources = Timesheets::getCurrentProjectTotalTime($model->id, $mtask['id_project'],'','2'); ?><?php echo $resources; ?></div>
			</div>
		<?php }   ?>
		
		<?php if (!in_array($mtask['id_task'], $mtaskArr)) { array_push($mtaskArr, $mtask['id_task']); ?>
			<div class="thead task_thead" data-id="<?php echo $mtask['id_task'];?>" data-default="2" data-billable="<?php echo $mtask['task_billabillity'];?>">
				<div class="column250 item side-borders side-borders-first"><span class="deleteFromTimesheet" data-id="<?php echo $mtask['id_task']; ?>"></span>&nbsp;&nbsp;&nbsp;<?php echo $mtask['task_description']?></div>
					<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?> weekendtask <?php } ?>">
						<?php $taskCertainDate = $model->week_start; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $mtask['id_task'], $taskCertainDate,'2'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($mtask['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="<?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?>weekendtask<?php } else { } ?>"  />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start . ' + 1 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $mtask['id_task'], $taskCertainDate,'2'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($mtask['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend=" " />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start  . ' + 2 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $mtask['id_task'], $taskCertainDate,'2'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($mtask['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start  . ' + 3 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $mtask['id_task'], $taskCertainDate,'2'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>"data-reason="<?php echo Timesheets::getReasonByUTID($mtask['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"   data-weekend="" />
					</div>
					<div class="column80 item side-borders">
						<?php $taskCertainDate = $model->week_start  . ' + 4 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $mtask['id_task'], $taskCertainDate,'2'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($mtask['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="" />
					</div>
					<div class="column80 item side-borders <?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?> weekendtask <?php } ?>">
						<?php $taskCertainDate = $model->week_start  . ' + 5 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $mtask['id_task'], $taskCertainDate,'2'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($mtask['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"   data-weekend="<?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?>weekendtask<?php } else { } ?>" />
					</div>
					<div class="column80 item side-borders weekendtask">
						<?php $taskCertainDate = $model->week_start  . ' + 6 day'; $resources = Timesheets::getUserTimeOnTaskByDay($model->id, $mtask['id_task'], $taskCertainDate,'2'); ?>
						<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-comment="<?php echo $resources['comment']; ?>" data-reason="<?php echo Timesheets::getReasonByUTID($mtask['id_task'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-weekend="weekendtask" />
					</div>	
				<div class="column80 item side-borders side-borders-last"><span><?php echo Timesheets::getUserTimeOnTaskByDay($model->id, $mtask['id_task'],'','2'); ?></span></div>
			</div>
		<?php } ?>
	<?php } ?>	
		...
		<div class="thead task_thead default" data-id="<?php echo $default_task['id'];?>" data-default="1" data-billable="<?php echo $default_task['billable'];?>">
			<div class="column250 tss item side-borders side-borders-first" style="line-height:14px;"><!--<span class="deleteFromTimesheet" data-id="<?php /*echo $default_task['id']; */?>"></span>&nbsp;&nbsp;&nbsp;--><?php echo $default_task['name']?></div>
				<div class="column80 tss item side-borders <?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?> weekendtask <?php } ?>">
					...
					<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-lieu-of="<?php echo Timesheets::getLieuOfDate($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-ticket="<?php echo Timesheets::getSRsByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-customer="<?php echo Timesheets::getCustomerByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-reason="<?php echo Timesheets::getReasonByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-comment="<?php echo $resources['comment']; ?>" data-weekend="<?php if(Users::getBranchByUser($model->id_user)!='56' && Users::getBranchByUser($model->id_user)!='452') { ?>weekendtask<?php } ?>" />
				</div>
				<div class="column80 tss item side-borders ">
					...
					<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-lieu-of="<?php echo Timesheets::getLieuOfDate($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-ticket="<?php echo Timesheets::getSRsByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-customer="<?php echo Timesheets::getCustomerByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-reason="<?php echo Timesheets::getReasonByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-comment="<?php echo $resources['comment']; ?>"  data-weekend=""   />
				</div>
				<div class="column80 tss item side-borders ">
				...
				<div class="column80 tss item side-borders  <?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?> weekendtask <?php } ?>">
					...
					<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-lieu-of="<?php echo Timesheets::getLieuOfDate($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-ticket="<?php echo Timesheets::getSRsByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-customer="<?php echo Timesheets::getCustomerByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-reason="<?php echo Timesheets::getReasonByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-comment="<?php echo $resources['comment']; ?>"  data-weekend="<?php if(Users::getBranchByUser($model->id_user)=='56' || Users::getBranchByUser($model->id_user)=='452') { ?>weekendtask<?php } else { } ?>" />
				</div>
				<div class="column80 tss item side-borders  weekendtask">
					...
					<input type="text" readonly="readonly" name="" value="<?php echo $resources['amount'];?>" data-date="<?php echo date('Y-m-d H:i:s', strtotime($taskCertainDate))?>" data-lieu-of="<?php echo Timesheets::getLieuOfDate($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-ticket="<?php echo Timesheets::getSRsByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-customer="<?php echo Timesheets::getCustomerByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>" data-reason="<?php echo Timesheets::getReasonByUTID($default_task['id'], date('Y-m-d H:i:s', strtotime($taskCertainDate))); ?>"  data-comment="<?php echo $resources['comment']; ?>" data-weekend="weekendtask" />
				</div>	
