...
<div class="mytabs expenses_edit" >
	...
	<div id="expenses_items"  style="background-color:#f8f8f8">
	
		<div id="expenses_items_content"  class="grid border-grid">
			<?php  $this->widget('zii.widgets.grid.CGridView', array(
						'id'=>'items-grid-after',
						'dataProvider'=>$model->searchAfterHours(),
						'summaryText' => '',
					...
					array(
						...
						'visible' => true, 
						'htmlOptions' => array('class' => 'date-after'), 
						'headerHtmlOptions' => array('class' => 'date-after'),
					),
							...
							(
						            ...
						            (
						            	...
						            	'update' => array(
						            		...
						            		'options' => array(
						            			'onclick' => 'showAfterItemForm(this, false);return false;'
						            		),
										),
										'delete' => array(
