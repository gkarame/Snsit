<div class="mytabs expenses_edit">	
	<div id="expenses_items">
		...
		<div id="expenses_items_content"  class="grid border-grid">
			<?php  $this->widget('zii.widgets.grid.CGridView', array('id'=>'items-grid-sunday','dataProvider'=>$model->searchSunday(),
						'summaryText' => '','pager'=> Utils::getPagerArray(),'template'=>'{items}{pager}',
					'columns'=>array(							
					array('name' => 'id','header' => 'ID','value' => '$data->id','visible' => false,'htmlOptions' => array('class' => 'column120'),'headerHtmlOptions' => array('class' => 'column120'),),
					array('name' => 'from_date','header' => 'Date','value' => '$data->from_date','visible' => true, 
						'htmlOptions' => array('class' => 'date-sunday'),'headerHtmlOptions' => array('class' => 'date-sunday'),),					
					array('name' => 'to_date','header' => 'To Date','value' => '$data->to_date',
						'visible' => false,'htmlOptions' => array('class' => 'column0'),'headerHtmlOptions' => array('class' => 'column0'),),
					array('name' => 'PrimaryContact.firstname'.'PrimaryContact.lastname','header' => 'Primary Contact',
						...
						'visible' => true,'htmlOptions' => array('class' => 'column160'),'headerHtmlOptions' => array('class' => 'column160'),),					
					array('name' => 'SecondaryContact.firstname'.'SecondaryContact.lastname','header' => 'Secondary Contact',
						...
						'visible' => true,'htmlOptions' => array('class' => 'column120'),'headerHtmlOptions' => array('class' => 'column120'),),							array
						(
							'class'=>'CCustomButtonColumn', 'template'=>' {update} {delete}', 'htmlOptions'=>array('class' => 'button-column'),
        ...
        <?php $form=$this->beginWidget('CActiveForm', array('id'=>'sunday-form-details','enableAjaxValidation'=>false,
