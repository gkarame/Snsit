<div  id="support" class="tache-after new">
	...
	<?php $form=$this->beginWidget('CActiveForm', array('id'=>'after-form','enableAjaxValidation'=>false,)); ?>	    
			<div class="item inline-block time normal" style="cursor:pointer; margin-left:10px;">
					<?php echo $form->labelEx($model,'from_date'); ?>
					<div class="dataRow">
						<?php $this->widget('zii.widgets.jui.CJuiDatePicker',array('model'=> $model,'attribute' => "from_date", 
							'cssFile' => false,'options'=>array('dateFormat'=>'yy/mm/dd','showAnim' => 'fadeIn'),
				...
				<div class="item inline-block time normal" >
						...
						<div class="dataRow">
							<?php $this->widget('zii.widgets.jui.CJuiDatePicker',array('model'=> $model,'attribute' => "to_date", 
								'cssFile' => false,'options'=>array('dateFormat'=>'yy/mm/dd','showAnim' => 'fadeIn'),
								'htmlOptions' => array('class' => 'datefield'),)); ?>
							<span class="calendar calfrom"></span>
						</div>
