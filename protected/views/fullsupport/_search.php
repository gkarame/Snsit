	...
	<?php $form=$this->beginWidget('CActiveForm', array('action'=>Yii::app()->createUrl($this->route),'method'=>'get',	)); ?>		
		<div class="row width_project_name width229">
			<div class="inputBg_txt">
				...
				<?php $this->widget('zii.widgets.jui.CJuiAutoComplete',array('model' => $model,
						'attribute' => 'primary_contact','source'=>Users::getAllAutocomplete(),
		...
		<div class="row width_common">
			<div class="inputBg_txt">
				...
				<span class="spliter"></span>
				<?php $this->widget('zii.widgets.jui.CJuiAutoComplete',array('model' => $model,'attribute' => 'secondary_contact','source'=>Users::getAllAutocomplete(),
						'options'=>array('minLength'	=>'0','showAnim'	=>'fold',),
						'htmlOptions'	=>array('onfocus' 	=> "javascript:$(this).autocomplete('search','');",'class'		=> "width94"),)); ?>
			</div>
		</div>
		<div class="btn">
