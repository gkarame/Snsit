<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'eas-grid','dataProvider'=>$model->eas,'summaryText' => '',
	'pager'=> Utils::getPagerArray(),'template'=>'{items}{pager}',
	'htmlOptions' => array('class' => 'form_grid grid-view'),
	'columns'=>array(
		array(            
		...
		array(
			...
			'template'=>'{download} {share} {delete}',
			'htmlOptions'=>array('class' => 'button-column'),
            'buttons'=>array(
				'delete' => array(
					'label' => Yii::t('translations', 'Delete'),
					'imageUrl' => null,
					'url' => 'Yii::app()->createUrl("eas/delete", array("id"=>$data->id))',  
                	'options' => array(
                		'class' => 'delete',
					)
				),
