...
function createGridSupport(){$('.status_support_2').addClass("colorRed");val=<?php echo WidgetSupport::CharChart1()?>;ChartSupport(val,"graph-support");ChartSupport(val,"graph-support1")};function ChartSupport(val,id){var dataSource=val;$("#"+id).dxChart({dataSource:dataSource,commonSeriesSettings:{type:"spline",argumentField:"month"},commonAxisSettings:{grid:{visible:!0}},series:<?php echo WidgetSupport::getSeries();?>,tooltip:{enabled:!0},legend:{verticalAlignment:"bottom",horizontalAlignment:"center",rowCount:4},valueAxis:{max:100,name:'Value Axis 1',valueType:"numeric"},commonPaneSettings:{border:{visible:!0,bottom:!1}}})}
